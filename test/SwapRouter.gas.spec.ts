import { abi as ICytoswapV3PoolABI } from '@cytoswap/v3-core/artifacts/contracts/interfaces/ICytoswapV3Pool.sol/ICytoswapV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { ICytoswapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [ICytoswapV3Pool, ICytoswapV3Pool, ICytoswapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, ICytoswapV3PoolABI, wallet)) as [
      ICytoswapV3Pool,
      ICytoswapV3Pool,
      ICytoswapV3Pool
    ]
  ...
  let pools: [ICytoswapV3Pool, ICytoswapV3Pool, ICytoswapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestCytoswapV3Callee')
