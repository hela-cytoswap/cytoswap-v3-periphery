...
- Bugs in any third party contract or platform that interacts with Cytoswap V3.
- Vulnerabilities already reported and/or discovered in contracts built by third parties on Cytoswap V3.
...
- Discover a previously unreported, non-public vulnerability that would result in a loss of and/or lock on any ERC-20 token on Cytoswap V3 (but not on any third party platform interacting with Cytoswap V3) and that is within the scope of this Program. Vulnerabilities must be distinct from the issues covered in the Trail of Bits or ABDK audits.
...
- Make a good faith effort to avoid privacy violations, destruction of data, interruption or degradation of Cytoswap V3.
